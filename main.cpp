...
//	objList.push_back(make_shared<QuadMesh3D>(1.f, 1.5f, 6, 8, Pose{0.5f, 0.f, 0.f, -15.f, 0.f, 15.f}));
	//objList.push_back(make_shared<Cylinder3D>(0.5f, 0.5f, 1.f, 12, 8, true, Pose{0.f, 2.f, -0.5f, 45.f, 45.f, 0.f}));
    objList.push_back(make_shared<House> (Pose{0.f, 0.f, 0.f, 0.f, 0.f, 0.f}, Motion::NULL_MOTION));
    objList.push_back(make_shared<Sphere3D> (1.f, Pose{0.f, 0.f, 0.f, 0.f, 0.f, 0.f}));
	objList.back()->setMaterial(gray2);
